...
Allow: /
Sitemap: https://filmgeneva.com/sitemap.xml
Crawl-delay: 1
Disallow: /api/
`;
...
- [Home](https://filmgeneva.com/) \u2014 Overview of services, clients, and company information
- [Video Production](https://filmgeneva.com/video-production) \u2014 Corporate video, documentaries, event filming, NGO content
- [Livestreaming](https://filmgeneva.com/livestreaming-geneva) \u2014 Conference, hybrid event, and concert livestreaming
- [Photography](https://filmgeneva.com/photography-geneva) \u2014 Event, corporate, portrait, real estate, and product photography
- [Podcasts & Audio](https://filmgeneva.com/podcast-recording-geneva) \u2014 Podcast recording, concert recording, lecture recording
- [Production Company](https://filmgeneva.com/production-company-geneva) \u2014 End-to-end production support: location scouting, permits, crew, equipment
- [About](https://filmgeneva.com/about-filmgeneva) \u2014 Company background, equipment, and client testimonials
- [Contact](https://filmgeneva.com/contact-filmgeneva) \u2014 Phone, email, WhatsApp, Signal, Telegram, and quote request form

## Notable specialised pages

- [NGO Video Production](https://filmgeneva.com/ngo-video-production-geneva)
- [Conference Filming](https://filmgeneva.com/conference-filming-geneva)
- [Wedding Videography](https://filmgeneva.com/wedding-videographer-geneva)
- [Drone & Aerial Filming](https://filmgeneva.com/drone-filming-geneva-switzerland)
- [Watch & Jewellery Photography](https://filmgeneva.com/watch-photography-geneva)
- [Political & Diplomatic Video](https://filmgeneva.com/political-diplomatic-video-geneva)
- [WHO Interview Production](https://filmgeneva.com/who-interview-production-geneva)
...
async function renderRoute(request, env2, route) {
  ...
  const canonicalUrl = "https://filmgeneva.com" + route.url;
...
var worker_default = {
  async fetch(request, env2, ctx) {
    ...
    if (url.hostname === "filmgeneva.ch" || url.hostname === "www.filmgeneva.ch" || url.hostname === "www.filmgeneva.com") {
      return Response.redirect("https://filmgeneva.com" + url.pathname + url.search, 301);
    }
    if (path === "/robots.txt") {
